        ...
        <div className="border-t border-gray-800 pt-8 pb-6">
          <div className="flex justify-center items-center space-x-6">
            <a
              ...
              className="group flex items-center justify-center w-10 h-10 rounded-full bg-pink-500 hover:bg-pink-600 transition-all duration-300 hover:rotate-12"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-center w-10 h-10 rounded-full bg-black hover:bg-gray-800 transition-all duration-300 hover:rotate-12"
              aria-label="TikTok"
            >
              <svg
